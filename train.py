...
Usage:
    $ python path/to/train.py --data coco128.yaml --weights runs/train/exp7/weights/best.pt --img 640
"""
import argparse
import math
import os
...
def run(**kwargs):
    # Usage: import train; train.run(data='coco128.yaml', imgsz=320, weights='runs/train/exp7/weights/best.ptv3.pt')
    opt = parse_opt(True)
